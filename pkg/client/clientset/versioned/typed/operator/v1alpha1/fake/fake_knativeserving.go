...
var knativeservingsResource = v1alpha1.SchemeGroupVersion.WithResource("knativeservings")

var knativeservingsKind = v1alpha1.SchemeGroupVersion.WithKind("KnativeServing")
