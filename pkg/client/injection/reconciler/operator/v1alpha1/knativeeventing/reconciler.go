...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.KnativeEventing, desired *v1alpha1.KnativeEventing) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.KnativeEventing, desiredFinalizers sets.String) (*v1alpha1.KnativeEventing, error) {
	// Don't modify the informers copy.
