...
import (
	...
	knativeeventing "knative.dev/operator/pkg/client/injection/informers/operator/v1alpha1/knativeeventing"
...
const (
	defaultControllerAgentName = "knativeeventing-controller"
	defaultFinalizerName       = "knativeeventings.operator.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	knativeeventingInformer := knativeeventing.Get(ctx)

	lister := knativeeventingInformer.Lister()
