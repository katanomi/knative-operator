...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.KnativeServing, desired *v1alpha1.KnativeServing) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.KnativeServing, desiredFinalizers sets.String) (*v1alpha1.KnativeServing, error) {
	// Don't modify the informers copy.
